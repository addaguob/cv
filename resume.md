...
- Backend: FastAPI, REST APIs, SQLModel, SQLAlchemy, authentication, RBAC
- Databases: SQLite, PostgreSQL (basics)
- Testing/Quality: pytest, httpx/requests, basic QA automation concepts
- Tooling/DevOps: Git/GitHub, GitHub Actions (basic), Docker (basic), Linux
...
- Extracted reusable components (auth, ORM models, service layer) to accelerate follow-on projects.

#### Open-Source Utilities & Experiments
2023 – Present
- Built small CLI/GUI tools, web scraping automation, and data conversion pipelines.
- Maintain an active GitHub portfolio showing consistent delivery and learning.

## Professional Development

### Udemy: Python From Scratch & Selenium WebDriver QA Automation
Updated Dec 2025 | ~39h 45m
- Python fundamentals to practical scripting; Selenium WebDriver automation; basic framework structure; HTML reporting.
- Reinforced debugging, test automation workflows, and SQL fundamentals commonly used in QA/automation.

### Udemy: C# .NET with MS SQL — Complete Beginner to Master
Updated Aug 2025 | ~24h 15m
- Practiced backend fundamentals: building REST APIs with modern .NET and writing T-SQL for MS SQL Server/Azure SQL.
